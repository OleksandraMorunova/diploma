...
public class PhoneNumberValidation {
    ...
    public PhoneNumberValidation(Context context) {
        this.context = context;
    }

    public PhoneNumberValidation(Context context, LifecycleOwner fragment, ViewModelStoreOwner viewModelStoreOwner) {
        this.context = context;
    ...
    public void requestUserByPhoneNumber(String phoneNumber, Class<?> o){
        ...
        viewModel.getDetailsByPhone(phoneNumber.replace(" ", "").replace("-", "")).observe(lifecycleOwner, userEntity -> {
            try{
               if(userEntity != null){
                   context.startActivity(new Intent(context, o).putExtra("number", phoneNumber));
